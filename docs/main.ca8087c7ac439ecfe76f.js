    ...
    <div class=${_navbar_module_scss__WEBPACK_IMPORTED_MODULE_1__.default["nav-wrapper"]}>
      <nav name="nav-container" class=${_navbar_module_scss__WEBPACK_IMPORTED_MODULE_1__.default.container}>
        <div class=${_navbar_module_scss__WEBPACK_IMPORTED_MODULE_1__.default["content-container"]}>
          <div class=${_navbar_module_scss__WEBPACK_IMPORTED_MODULE_1__.default["logo-container"]}>${(_images_logo_svg__WEBPACK_IMPORTED_MODULE_0___default())}</div>
        </div>
      </nav>
    </div>
  `;
